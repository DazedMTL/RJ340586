...
BattleResult.prototype.updateLevelAnimation = function () {
    ...
    this._spriteActor.opacity += 20;
    this._levelLayout.opacity += 20;
    this._name.opacity += 20;
    this._par.opacity += 20;
    if (this._skill) {
...
BattleResult.prototype.updateLevelPosition = function () {
    ...
    ;
    this._spriteActor.x = this.sprite_move_to(this._spriteActor.x, Moghunter.bresult_actor_x, 200);
    // mod tatsunoko
