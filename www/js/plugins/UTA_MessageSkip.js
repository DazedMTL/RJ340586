...
(function (utakata) {
    ...
    var MessageSkip = (function () {
        ...
        MessageSkip.prototype.isPressedMsgSkipButton = function () {
            return Input.isPressed(this._skipKey) || Input.isPressed('pagedown');
        };
...
(function () {
    ...
    Alt_Func.enableMessSkip = function () {
        this._enableSkip = true;
    }
    Alt_Func.disableMessSkip = function () {
        this._enabledSkip = false;
    }
    Alt_Func.isEnabledSkip = function () {
        return this._enabledSkip;
    }
    ...
    Window_Message.prototype.updateShowFast = function () {
        ...
        if (Alt_Func.isEnabledSkip() && utakata.MessageSkip.isPressedMsgSkipButton()) {
            this._showFast = true;
