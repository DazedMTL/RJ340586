...
ActorDataWindow.prototype.refreshParameters = function () {
	...
	this._par.bitmap.drawText(this._actor.mat, -60, 166, 160, 32, "right");
	this._par.bitmap.drawText(this._actor.mdf, 30, 166, 160, 32, "right");
	this._par.bitmap.drawText(this._actor.agi, -60, 200, 160, 32, "right");
	this._par.bitmap.drawText(this._actor.luk, 30, 200, 160, 32, "right");
	this._par.bitmap.drawText(this._actor.name(), 70, 30, 160, 32, "left");

	// tatsunoko
	const spMap = { 1: 74, 2: 76, 3: 78, 4: 80 };
	const apMap = { 1: 75, 2: 77, 3: 79, 4: 81 };
	const cSp = spMap[this._actor._actorId];
	const cAp = apMap[this._actor._actorId];

	this._par.bitmap.drawText($gameVariables.value(cSp), -60, 233, 160, 32, "right");
	this._par.bitmap.drawText($gameVariables.value(cAp), 30, 233, 160, 32, "right");
