...
Scene_Equip.prototype.create = function () {
	ImageManager.reserveCosplayImg();
...
// Add tatsunoko====>
//==============================
// * Create createActorImg
//==============================
// Scene_Equip.prototype.createActorImg = function () {
// 	//preLoadCharCosplayImgByActorIdFromEquipScene();
// 	this._field.addChild(this._actorImg);
// };

// Scene_Equip.prototype.refreshActorImg = function (actorId) {
// 	if (!this._actorImg) {
// 		this._actorImg = new Sprite();
// 	}
// 	this._actorImg.bitmap = getCharCosplayImgByActorId(actorId);
// 	this._actorImg = new Sprite(getCharCosplayImgByActorId(actorId));
// 	this._actorImg.scale.x = 0.607;
// 	this._actorImg.scale.y = 0.607;
// 	this.adjustPostionChar(actorId);
// };

// var _dobby_mog_scene_Scene_Equip_refreshActor = Scene_Equip.prototype.refreshActor;
// Scene_Equip.prototype.refreshActor = function() {
// 	_dobby_mog_scene_Scene_Equip_refreshActor.call(this);
// 	this.refreshActorImg(this.actor()._actorId);
// };

// var _dobby_mog_scene_Scene_Equip_onItemOk = Scene_Equip.prototype.onItemOk;
// Scene_Equip.prototype.onItemOk = function() {
// 	_dobby_mog_scene_Scene_Equip_onItemOk.call(this);
// 	this.refreshActorImg(this.actor()._actorId);
// };


// Scene_Equip.prototype.adjustPostionChar = function (actorId) {
// 	if (this._actorImg) {
// 		switch(actorId){
// 			case 1:
// 				this._actorImg.x = 500;
// 				this._actorImg.y = -100;
// 				break;
// 			case 2:
// 				this._actorImg.x = 500;
// 				this._actorImg.y = -100;
...
// var _dobby_mog_scene_Scene_Equip_commandOptimize = Scene_Equip.prototype.commandOptimize;
// Scene_Equip.prototype.commandOptimize = function() {
// 	_dobby_mog_scene_Scene_Equip_commandOptimize.call(this);
// 	this.refreshActorImg(this.actor()._actorId);
// };

// var _dobby_mog_scene_equip_Scene_Equip_commandClear = Scene_Equip.prototype.commandClear;
// Scene_Equip.prototype.commandClear = function() {
//     _dobby_mog_scene_equip_Scene_Equip_commandClear.call(this);
// 	this.refreshActorImg(this.actor()._actorId);
// };
// <====Add tatsunoko
//==============================
...
Scene_Equip.prototype.updateLayout = function () {
	...
	if (this._commandWindow.opacity != 0) {
		this._commandWindow.opacity = 0;
	}
	if (this._commandWindow.width != 500) {
		this._commandWindow.width = 500;
	}
	...
	if (this._slotWindow.opacity != 0) {
		this._slotWindow.opacity = 0;
	}
	if (this._slotWindow.width != 500) {
	...
	if (this._itemWindow.opacity != 0) {
		this._itemWindow.opacity = 0;
	}
	if (this._itemWindow.width != 500) {
		this._itemWindow.width = 500;
	}
	...
	if (this._statusWindow.opacity != 0) {
