...
// add tatsunoko
Scene_Status.prototype.changeBackground = function () {
	// this._backgroundSprite.bitmap = ImageManager.loadMenusstatus("actor_"+this._actor._actorId);
	// this._backgroundSprite._refresh();
	this.createCharBackGround();
};
...
// add tatsunoko
Scene_Status.prototype.createInitBackground = function () {
	// this._backgroundSprite.bitmap = ImageManager.loadMenusstatus("actor_"+this._actor._actorId);
	// this._backgroundSprite._refresh();
	this.createCharBackGround();
};

Scene_Status.prototype.createCharBackGround = function () {
	if (this._actor) {
		let actorImgName = "actor_" + this._actor._actorId;
		switch (this._actor._actorId) {
			case 1:
				switch ($gameVariables.value(15)) {
					case 3:
						actorImgName = actorImgName + "_3";
						break;
					case 2:
						actorImgName = actorImgName + "_2";
						break;
					default:
						actorImgName = actorImgName + "_1";
						break;
				}
				break;
			default:
		...
		this._backgroundSprite.bitmap = ImageManager.loadMenusstatus(actorImgName);
		this._backgroundSprite._refresh();
	}
};
...
Scene_Status.prototype.createBust = function () {
	...
	// Mod tatsunoko
	//var adjustY = ImageManager.getActorStatusImgAdjustY(this._actor._actorId);
	this._bust.y = Moghunter.scStatus_BustY + 0;
...
Scene_Status.prototype.refreshBust = function () {
	...
	//this._bust.bitmap = getCharCosplayImg(this._actor);
	//this._bust.y = Graphics.boxHeight;
	//var adjustY = ImageManager.getActorStatusImgAdjustY(this._actor._actorId);
	this._bust.y = Moghunter.scStatus_BustY + 0;
	this._bust.org[1] = this._bust.y;
...
Window_Status.prototype.refresh = function () {
	...
	if (this._actor) {
		...
		// tatsunoko
		const ITEM_NAME_WIDTH = 220;
		this.drawItemName(this._actor.equips()[0], Moghunter.scStatus_WeaponX, Moghunter.scStatus_WeaponY, ITEM_NAME_WIDTH);
		this.drawItemName(this._actor.equips()[1], Moghunter.scStatus_ShieldX, Moghunter.scStatus_ShieldY, ITEM_NAME_WIDTH);
		this.drawItemName(this._actor.equips()[2], Moghunter.scStatus_HelmetX, Moghunter.scStatus_HelmetY, ITEM_NAME_WIDTH);
		this.drawItemName(this._actor.equips()[3], Moghunter.scStatus_ArmorX, Moghunter.scStatus_ArmorY, ITEM_NAME_WIDTH);
		this.drawItemName(this._actor.equips()[4], Moghunter.scStatus_AccX, Moghunter.scStatus_AccY, ITEM_NAME_WIDTH);
