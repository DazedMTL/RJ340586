...
Scene_Skill.prototype.loadBitmaps = function () {
	// Add tatsunoko
	this._layImgActorImg = new Sprite();
...
Scene_Skill.prototype.createLayout = function () {
	...
	// Add tatsunoko
	this._field.addChild(this._layImgActorImg);
};
...
Scene_Skill.prototype.refreshStatusActor = function () {
	...
	// Add tatsunoko
	this._layImgActorImg.bitmap = getCharCosplayImg(this._actor);
	this.adjustPostionChar(this.actor()._actorId);
};
...
Scene_Skill.prototype.onActorChange = function () {
	...
	this._itemWindow.x = this._itemPosOrg[0] - 50;
	// Add tatsunoko
	this._layImgActorImg.bitmap = getCharCosplayImg(this.actor());
	this.adjustPostionChar(this.actor()._actorId);
};

// Add tatsunoko
Scene_Skill.prototype.adjustPostionChar = function (actorId) {
	if (this._layImgActorImg) {
		switch (actorId) {
			case 1:
				this._layImgActorImg.x = 450;
				this._layImgActorImg.y = -100;
				break;
			case 2:
				this._layImgActorImg.x = 450;
				this._layImgActorImg.y = -150;
				break;
			case 3:
				this._layImgActorImg.x = 450;
				this._layImgActorImg.y = -70;
				break;
			case 4:
				this._layImgActorImg.x = 450;
				this._layImgActorImg.y = -100;
		...
		this._layImgActorImg.scale.x = 0.607;
		this._layImgActorImg.scale.y = 0.607;
	}
};
