...
(function () {
	...
	Graphics.printLink = function (url, title) {
		if (window.RPGAtsumaru && window.RPGAtsumaru.popups && window.RPGAtsumaru.popups.openLink) {
			...
			if (url == 'https://www.dlsite.com/maniax/circle/profile/=/maker_id/RG28277.html') {
				link = '<a href="' + url + '" target="_blank" id="HyperLink"><img src="img/pictures/banner/dlsitebanner.png" alt="次へ"></a>';
			} else if (url == 'https://dragon-slayer-wiki.studio-dobby.com/') {
				link = '<a href="' + url + '" target="_blank" id="HyperLink"><img src="img/pictures/banner/strategybanner.png" alt="次へ"></a>';
			} else if (url == 'https://ci-en.dlsite.com/creator/2868') {
				link = '<a href="' + url + '" target="_blank" id="HyperLink"><img src="img/pictures/banner/cienbanner.png" alt="次へ"></a>';
			} else if (url == 'https://studio-dobby.com/products/dragon-slayer/qa/') {
				link = '<a href="' + url + '" target="_blank" id="HyperLink"><img src="img/pictures/banner/circlebanner.png" alt="次へ"></a>';
			} else if (url == 'https://www.pixiv.net/users/12101996') {
				link = '<a href="' + url + '" target="_blank" id="HyperLink"><img src="img/pictures/banner/pixivbanner.png" alt="次へ"></a>';
			}
